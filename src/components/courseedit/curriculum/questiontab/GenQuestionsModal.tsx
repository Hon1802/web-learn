...
const QuestionsModal: React.FC<QuestionsModalProps> = ({ open, onClose }) => {
   ...
   const handleGenerate = async () => {
      const response = await genQuestion(count, lang, difficulty, description);
   ...
   return (
      <Modal open={open} onClose={onClose}>
         ...
         >
            ...
            {/* Display generated questions with checkboxes */}
            <Box sx={{ mt: 3 }}>
                     ...
                     <FormControlLabel
                        control={
                           <Checkbox
                              ...
                              onChange={() =>
                                 handleCheckboxChange(question.question_text)
                              }
                           />
                        }
